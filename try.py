# qc_scraper.py
"""
QC Scraper - Integrated semantic + NLP quality control for scraped pages

Input file columns expected (case-insensitive):
 - Company Name
...
Output CSV columns:
 Company, Link, Keyword, Content Type, Relevant or Not, Chunk, Score Level, Explanation, OCR Keywords & Image Links, Predicted Category, Entities Found, Sentiment, Load Status

Usage:
    python qc_scraper.py input.xlsx output.csv
    python qc_scraper.py input.csv output.csv
"""
...
# Optional translator lib - if not installed, translation will be skipped gracefully
try:
